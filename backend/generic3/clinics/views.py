...
@api_view(['GET'])
def get_clinic_details(request, clinic_id):
    """
    Retrieve details of a specific clinic.
    """
...
def add_clinic(request):
    ...
    return JsonResponse({"message": "Clinic added successfully"}, status=status.HTTP_201_CREATED)
