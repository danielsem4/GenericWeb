...
urlpatterns = [
    ...
    path('api/v1/users/<int:clinic_id>/user/<int:user_id>/', views.get_user_details, name='get_user_details'),
    path('api/v1/users/<int:user_id>/qr-code/', views.get_user_qr_code, name='get_user_qr_code'),
    path('api/v1/users/<int:clinic_id>/add/', views.add_user, name='add_user'),
